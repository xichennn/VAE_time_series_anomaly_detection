...
class VAEAnomalyDetection(pl.LightningModule, ABC):
    ...
    def predict(self, x) -> dict:
        ...
        latent_sigma = softplus(latent_sigma)+1e-16
...
class VAEAnomalyTabular(VAEAnomalyDetection):
    ...
    def make_decoder(self, latent_size, output_size):
        ...
        return nn.Sequential(
            ...
            nn.Linear(20, 50),
            nn.ReLU(),
            nn.Linear(50, output_size * 2)  # times 2 because this is the concatenated vector of reconstructed mean and variance
        )
